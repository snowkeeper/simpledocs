...
module.exports = function(callback) {
	...
	var ghroute = this.get('ghpages route') || route;
	...
	simpledocs.paths = {
		...
		ghpages: {
			...
			page: route.substring(1) + '-json' + '/page/',
			tree: route.substring(1) + '-json' + '/tree',
			search: route.substring(1) + '-json' + '/search/',
			allinone: route.substring(1) + '-json' + '/allinone/'
		},
	}
	...
	console.log("/__simpledocs__" + route + "/user.js");
