...
module.exports = function(callback) {
	...
	app.get(wild + "/__simpledocs__/user", userConfig); 
	//app.get(material + "/__simpledocs__/user", userConfig); 
	app.get(wild + "/__simpledocs__/config", sdConfig);
	...
	function uiView(req, res, ui) {		 
		...
		var locals = {
			...
			pathConfig: wild + "/__simpledocs__/config",
			pathUser: wild + "/__simpledocs__/user",
			section: {},
			singleBranch: simpledocs.get('menu single branch'),
