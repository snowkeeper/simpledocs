	...
	toggleMenu: function(e) {
		...
		if(!this._toggled) {
			selector
				...
				.animate({height: selector.data('nHeight')-150},400, function() {
	...
	render: function() {
		...
		return (
			React.DOM.div(null, 
				...
				React.DOM.div({className: "col-xs-12 col-sm-4 col-md-3 col-lg-2", id: "menu", 'data-target': "#simpledocs", 'data-spy': "affix", 'data-offset-top': "45"}, 
