...
bone.History = (function() {
  ...
  History.prototype.loadUrl = function(fragmentOverride) {
    var args, fragment, handler, _base, _i, _len, _ref, _ref1, _isHandler;
 ...
 */
	...
	snowUI.stickyMenu = function() {
		...
		function scroller(){ 
			...
			if (simpledocs.scrollTop > 35){
				appbarTitle.style.width = menu.clientWidth - 55 +'px';
...
var Alert2 = function (_React$Component) {
	_inherits(Alert2, _React$Component);

	function Alert2(props) {
		_classCallCheck(this, Alert2);

		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Alert2).call(this, props));

		_this.displayName = 'Alert Component';
		_this.state = {
			isVisible: true
		};
		return _this;
	...
	_createClass(Alert2, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: "alert " + this.props.showclass + " alert-dismissable", role: 'alert' },
				_react2.default.createElement(
					'button',
					{ type: 'button', onClick: this.dismissAlert, className: 'close', 'data-dismiss': 'alert', 'aria-label': 'Close' },
					_react2.default.createElement(
						'span',
						{ 'aria-hidden': 'true' },
						'×'
...
var AppIfo = function (_React$Component) {
	_inherits(AppIfo, _React$Component);

	function AppIfo(props) {
		_classCallCheck(this, AppIfo);

		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AppIfo).call(this, props));

		_this.displayName = 'AppInfo Component';
		_this.state = {};
		return _this;
	}
	...
	_createClass(AppIfo, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ id: 'easter-egg', style: { display: 'none' } },
				_react2.default.createElement(
					'div',
					{ className: 'col-xs-offset-1 col-md-offset-1' },
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ href: 'https://github.com/inquisive/simpledocs', target: '_blank' },
									'source'
								),
								'   |   ',
								_react2.default.createElement(
									'a',
									{ href: 'https://github.com/inquisive/simpledocs/archive/latest.zip', target: '_blank' },
									'latest.zip'
								),
								'  |  ',
								_react2.default.createElement(
									'a',
									{ href: 'https://github.com/inquisive/simpledocs/archive/latest.tar.gz', target: '_blank' },
									'latest.tar.gz'
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ href: 'https://npmjs.org/package/simpledocs', target: '_blank' },
									'Package Info'
								)
							)
						),
						_react2.default.createElement('div', { style: { borderBottom: 'transparent 15px solid' } })
					),
					_react2.default.createElement('div', { className: 'clearfix', style: { borderBottom: 'transparent 15px solid' } }),
					_react2.default.createElement(
						'div',
						{ className: 'col-xs-11 col-md-10' },
						_react2.default.createElement(
							'h4',
							null,
							'Theme'
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ title: 'change theme', className: 'col-sm-12' },
								_react2.default.createElement(
									'a',
									{ style: { cursor: 'pointer' }, onClick: function onClick(e) {
											return snowUI.setTheme('');
										} },
									'White theme'
								),
								'   |   ',
								_react2.default.createElement(
									'a',
									{ style: { cursor: 'pointer' }, onClick: function onClick(e) {
											return snowUI.setTheme('light-theme');
										} },
									'Blue theme'
								),
								'   |  ',
								_react2.default.createElement(
									'a',
									{ style: { cursor: 'pointer' }, onClick: function onClick(e) {
											return snowUI.setTheme('dark-theme');
										} },
									'Dark theme'
								),
								'  |  ',
								_react2.default.createElement(
									'a',
									{ style: { cursor: 'pointer' }, href: snowUI.path.material },
									'material-ui'
								)
							),
...
var Banner = function (_React$Component) {
	...
	function Banner(props) {
		...
		_this.displayName = 'Banner Component';
		_this.state = {
			mounted: false
		};
		return _this;
	...
	_createClass(Banner, [{
		...
		value: function render() {
			...
			var xs = snowUI.breaks.bannerMenu[0] === 0 ? 'hidden-xs' : 'col-xs-' + snowUI.breaks.bannerMenu[0];
			var sm = snowUI.breaks.bannerMenu[1] === 0 ? 'hidden-sm' : 'col-sm-' + snowUI.breaks.bannerMenu[1];
			var md = snowUI.breaks.bannerMenu[2] === 0 ? 'hidden-md' : 'col-md-' + snowUI.breaks.bannerMenu[2];
			var lg = snowUI.breaks.bannerMenu[3] === 0 ? 'hidden-lg' : 'col-lg-' + snowUI.breaks.bannerMenu[3];
			var xsT = snowUI.breaks.bannerContent[0] === 0 ? 'hidden-xs' : 'col-xs-' + snowUI.breaks.bannerContent[0];
			var smT = snowUI.breaks.bannerContent[1] === 0 ? 'hidden-sm' : 'col-sm-' + snowUI.breaks.bannerContent[1];
			var mdT = snowUI.breaks.bannerContent[2] === 0 ? 'hidden-md' : 'col-md-' + snowUI.breaks.bannerContent[2];
			var lgT = snowUI.breaks.bannerContent[3] === 0 ? 'hidden-lg' : 'col-lg-' + snowUI.breaks.bannerContent[3];

			var banner = _react2.default.createElement(
				'div',
				{ className: 'banner-inside' },
				_react2.default.createElement(
					'div',
					{ id: 'name', className: xs + " " + sm + " " + md + " " + lg + " " },
					_react2.default.createElement(
						'div',
						{ className: 'inside' },
						snowUI.name
				...
				_react2.default.createElement(
					'div',
					{ id: 'title', className: xsT + " " + smT + " " + mdT + " " + lgT + " " },
					_react2.default.createElement(
						'div',
						{ className: 'inside' },
						_typeof(this.props.page) === 'object' && this.props.page.term ? 'search: ' + this.props.page.term : this.props.title
					)
				),
				_react2.default.createElement(
					'div',
					{ id: 'logo' },
					_react2.default.createElement('a', { onClick: this.openEgg })
				)
			);
...
var Content = function (_React$Component) {
	...
	function Content(props) {
		...
		_this.displayName = 'Content Component';
		_this.state = {
			ready: yes,
			register: no,
			mounted: no,
	...
	_createClass(Content, [{
		...
		value: function render() {
			...
			if (this.state.error) {
				renderMe = _react2.default.createElement(UI.displayMessage, { message: this.state.message, type: 'warning' });
			} else if (!this.state.ready) {
				snowlog.warn('empty render for content');
				return _react2.default.createElement('div', null);
			} else if (UI[showcomp]) {
				var po = UI[showcomp];
				renderMe = _react2.default.createElement('po', { config: this.props.config });
			} else {
				renderMe = _react2.default.createElement(UI.displayMessage, { title: '404 Not Found', message: 'I could not find the page you are looking for. ', type: 'requesterror' });
			}
			return renderMe;
		}
	}, {
...
var Menu = function (_React$Component) {
	...
	function Menu(props) {
		...
		_this2.displayName = 'Menu Component';
		_this2.state = {
			ready: yes,
			register: no,
			mounted: no,
		...
		value: function render() {
			...
			var printMenu = function printMenu(pages, skiptree) {
				var list = pages.map(function (v) {
					...
					var rantree = active === 'active' && !snowUI.singleBranch ? true : skiptree === undefined ? runTree(propPage, v.documents) : skiptree;
					...
					if (_this.props.config.allinone) {
						var linkto = _react2.default.createElement(
							'a',
							{
						...
						var linkto = _react2.default.createElement(
							'a',
							{ className: "list-group-item " + active, onClick: _this.props.hrefRoute, href: snowUI.path.root + '/' + v.slug },
							v.menuTitle || v.title
						);
					}
					return _react2.default.createElement(
    ...
    * */
				if (!snowUI.allinone || !v.documents.length) {
					var allinone = _react2.default.createElement('span', null);
				} else if (_this.props.config.allinone) {
					var allinone = _react2.default.createElement(
						'a',
						{ className: "list-group-item " + active, onClick: _this.props.hrefRoute, href: snowUI.path.root + '/' + propPage },
						snowUI.text['multi page']
					);
				} else {
					var allinone = _react2.default.createElement(
						'a',
						{ className: 'list-group-item', onClick: _this.props.hrefRoute, href: snowUI.path.root + '/' + snowUI.singlePage + '/' + propPage },
				...
				if (snowUI.search) {
					var search = _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('input', { className: 'form-control', placeholder: 'Search', title: 'Press Enter to submit search' })
						),
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								'a',
								{ className: 'list-group-item head', onClick: _this.props.toggleMenu },
								snowUI.text.menu
							)
						),
						_react2.default.createElement(
							...
							linkto,
							_react2.default.createElement('span', { className: 'glyphicon glyphicon-search searchToggle', onClick: _this.searchToggle })
						)
					);
				} else {
					var search = _react2.default.createElement(
...
var UI = function (_React$Component) {
	...
	function UI(props) {
		...
		var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(UI).call(this, props));

		_this2.displayName = 'UI Component';
		_this2.state = {
			pagedata: false,
			allinone: props.allinone
		};

		_this2._toggled = false;
		_this2.goToAnchor = _this2.goToAnchor.bind(_this2);
		_this2.getPage = _this2.getPage.bind(_this2);
		_this2.hrefRoute = _this2.hrefRoute.bind(_this2);
	...
	_createClass(UI, [{
		...
		value: function componentWillReceiveProps(props) {
			...
			if (this.state.page !== props.page || this.state.moon != props.moon) {
				...
				this.setState({
					...
					_this3.getPage(props.page, props.moon);
				});
				return;
			}
		...
		key: 'getPage',
		value: function getPage(getpage, moon) {
			this.setState({
				connecting: true,
				pagedata: false,
				searchdata: false
				...
				snowUI.ajax.GET(url, data, function (resp) {
					...
					if (resp.search) {
						...
						_this.setState(_state, function () {
							...
							snowUI.fadeIn();
							snowUI.code.__mountedPage(function () {
		...
		key: 'hrefRoute',
		value: function hrefRoute(route) {
		...
		key: 'goToAnchor',
		value: function goToAnchor(route) {
			var _this4 = this;
		...
		value: function toggleMenu(e) {
			...
			if (!this._toggled) {
				selector.data('oHeight', selector.height()).css('height', 'auto').data('nHeight', selector.height()).height(selector.data('oHeight')).animate({ height: selector.data('nHeight') + 50 }, 400, function () {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(UI.Banner, { title: page.title || this.state.page, page: page, onActionChange: this.handleBannerChange }),
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('span', { className: 'dropspan glyphicon glyphicon-chevron-down' })
					),
					_react2.default.createElement(UI.Menu, { config: this.state, hrefRoute: this.hrefRoute, goToAnchor: this.goToAnchor, getPage: this.getPage, toggleMenu: this.toggleMenu, page: this.state.page, moon: this.state.moon })
				),
				_react2.default.createElement(
					'div',
					{ className: xsC + " col-sm-offset-" + snowUI.breaks.menu[1] + " " + smC + " col-md-offset-" + snowUI.breaks.menu[2] + " " + mdC + " col-lg-offset-" + snowUI.breaks.menu[3] + " " + lgC + "", id: 'home' },
					_react2.default.createElement(
						'div',
						{ id: 'content-fader' },
						_react2.default.createElement(UI.home, { config: this.state, goToAnchor: this.goToAnchor, getPage: this.hrefRoute, contents: this.state.searchdata || this.state.pagedata, page: this.state.page, moon: this.state.moon })
					)
				),
				_react2.default.createElement('div', { className: 'simpledocs-footer' })
			);
		}
	}]);
...
var Home = function (_React$Component) {
	...
	function Home(props) {
		...
		_this2.displayName = 'Home Component';
		_this2.state = {
			ready: no,
			register: no,
			mounted: no,
	...
	_createClass(Home, [{
		...
		value: function render() {
			var _this = this;
			var printMenu = function printMenu(pages) {
				//snowlog.log('print menu', pages);
				var list = pages.map(function (v) {
					var onclick = !_this.props.config.allinone ? _this.props.getPage : function (e) {
						e.preventDefault();
						_this.props.goToAnchor(v.slug);
					};
					return _react2.default.createElement(
						'div',
						{ key: v.slug, className: 'link' },
						_react2.default.createElement(
							'a',
							{ onClick: onclick, href: snowUI.path.root + '/' + v.slug },
							v.title
						),
						_react2.default.createElement(
							'div',
			...
			if (this.state.ready && this.props.contents) {
				...
				if (snowUI.tree > 0) {
					menu = snowUI.tree.map(function (v) {
						...
						return _react2.default.createElement(
							'div',
							{ className: '', key: v.slug },
							_react2.default.createElement(
								'a',
								{ className: '', onClick: _this.props.getPage, href: snowUI.path.root + '/' + v.slug },
								v.title
							),
							v.documents.length > 0 ? printMenu(v.documents) : ''
						);
				...
				return _react2.default.createElement(
					'div',
					{ id: '' },
					_react2.default.createElement(snowUI.UI.AppInfo, null),
					menu
				);
			}
			...
			function displayDoc(doc, allinone) {
				if (doc.ok) {
					...
					if (results > 0) {
						var display = doc.results.map(function (result) {
							...
							var page = result.obj;
							var content = page.display === 1 ? page.markdown ? _react2.default.createElement(
								'div',
								{ key: 'fullcontent' },
								_react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: page.markdown.html } }),
								' '
							) : _react2.default.createElement('span', null) : page.display === 2 ? _react2.default.createElement(
								'div',
								{ key: 'fullcontent' },
								_react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: page.html } }),
								' '
							) : page.display === 3 ? _react2.default.createElement(
								'div',
								{ key: 'fullcontent' },
								' ',
								_react2.default.createElement('div', { key: 'fullcontentB', dangerouslySetInnerHTML: { __html: page.html } }),
								_react2.default.createElement('div', { key: 'fullcontentA', dangerouslySetInnerHTML: { __html: page.html } })
							) : page.display === 4 ? _react2.default.createElement(
								'div',
								{ key: 'fullcontent' },
								' ',
								_react2.default.createElement('div', { key: 'fullcontentA', dangerouslySetInnerHTML: { __html: page.html } }),
								_react2.default.createElement('div', { key: 'fullcontentB', dangerouslySetInnerHTML: { __html: page.markdown.html } })
							...
							return _react2.default.createElement(
								...
								_react2.default.createElement('div', { className: 'score', style: { width: parseFloat(score) * 100 + '%' } }),
								_react2.default.createElement(
									'div',
									{ className: 'blurb' },
									content
					...
					/* page data */
					var search = false;
					if ((typeof doc === 'undefined' ? 'undefined' : _typeof(doc)) !== 'object') doc = {};
					if (_typeof(doc.parent) !== 'object') doc.parent = {};
					var content = doc.display === 1 ? doc.markdown ? _react2.default.createElement(
						'div',
						{ key: 'fullcontent' },
						_react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: doc.markdown.html } }),
						' '
					) : _react2.default.createElement('span', null) : doc.display === 2 ? _react2.default.createElement(
						'div',
						{ key: 'fullcontent' },
						_react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: doc.html } }),
						' '
					) : doc.display === 3 ? _react2.default.createElement(
						'div',
						{ key: 'fullcontent' },
						' ',
						_react2.default.createElement('div', { key: 'fullcontentB', dangerouslySetInnerHTML: { __html: doc.markdown.html } }),
						_react2.default.createElement('div', { key: 'fullcontentA', dangerouslySetInnerHTML: { __html: doc.html } })
					) : doc.display === 4 ? _react2.default.createElement(
						'div',
						{ key: 'fullcontent' },
						' ',
						_react2.default.createElement('div', { key: 'fullcontentA', dangerouslySetInnerHTML: { __html: doc.html } }),
					...
					var newcontent = [];
					newcontent.push(_react2.default.createElement('input', { type: 'hidden', value: doc.slug, className: 'hiddenTitle' }));
					...
					if (doc.type === 1) {
						...
						display.unshift(_react2.default.createElement(
							'div',
							{ key: 'dualpage' },
							newcontent
						));
					...
					var next;
					if (snowUI.menu[doc._id]) {
						prev = snowUI.menu[doc.parent._id] ? _typeof(snowUI.menu[doc.parent._id].docs[doc.order - 2]) === 'object' ? _react2.default.createElement(
							'li',
							{ className: 'previous' },
							_react2.default.createElement(
								'a',
								{ href: snowUI.path.root + '/' + snowUI.menu[doc.parent._id].docs[doc.order - 2].slug, onClick: _this.props.getPage },
								'← ',
								snowUI.menu[doc.parent._id].docs[doc.order - 2].title
							)
						) : _react2.default.createElement('span', null) : _react2.default.createElement('span', null);
						next = snowUI.menu[doc._id] ? _typeof(snowUI.menu[doc._id].docs[0]) === 'object' ? _react2.default.createElement(
							'li',
							{ className: 'next' },
							_react2.default.createElement(
								'a',
								{ href: snowUI.path.root + '/' + snowUI.menu[doc._id].docs[0].slug, onClick: _this.props.getPage },
								'→ ',
								snowUI.menu[doc._id].docs[0].title
							)
						) : _react2.default.createElement('span', null) : _react2.default.createElement('span', null);
					} else if (doc.parent) {
						prev = snowUI.menu[doc.parent._id] ? _typeof(snowUI.menu[doc.parent._id].docs[doc.order - 2]) === 'object' ? _react2.default.createElement(
						...
						) : snowUI.menu[doc.parent.parent] ? _typeof(snowUI.menu[doc.parent.parent].docs[doc.parent.order - 1]) === 'object' ? _react2.default.createElement(
							'li',
							{ className: 'previous' },
							_react2.default.createElement(
								'a',
								{ href: snowUI.path.root + '/' + snowUI.menu[doc.parent.parent].docs[doc.parent.order - 1].slug, onClick: _this.props.getPage },
								'← ',
								snowUI.menu[doc.parent.parent].docs[doc.parent.order - 1].title
							)
						) : _react2.default.createElement('span', null) : _react2.default.createElement('span', null) : _react2.default.createElement('span', null);
						next = snowUI.menu[doc.parent._id] ? _typeof(snowUI.menu[doc.parent._id].docs[doc.order]) === 'object' ? _react2.default.createElement(
							'li',
							{ className: 'next' },
							_react2.default.createElement(
								'a',
								{ href: snowUI.path.root + '/' + snowUI.menu[doc.parent._id].docs[doc.order].slug, onClick: _this.props.getPage },
								'→  ',
								snowUI.menu[doc.parent._id].docs[doc.order].title
							)
						) : snowUI.menu[doc.parent.parent] ? _typeof(snowUI.menu[doc.parent.parent].docs[doc.parent.order]) === 'object' ? _react2.default.createElement(
							'li',
							{ className: 'next' },
							_react2.default.createElement(
								'a',
								{ href: snowUI.path.root + '/' + snowUI.menu[doc.parent.parent].docs[doc.parent.order].slug, onClick: _this.props.getPage },
								'→  ',
								snowUI.menu[doc.parent.parent].docs[doc.parent.order].title
							)
						) : _react2.default.createElement('span', null) : _react2.default.createElement('span', null) : _react2.default.createElement('span', null);
					}
				}
				...
				if (doc.links.length > 0) {
					related = doc.links.map(function (v) {
						return _react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ className: 'badge bg-primary', onClick: _this.props.getPage, href: snowUI.path.root + '/' + v.slug },
								v.title
							)
						);
					});
				...
				if (doc.externalLinks) {
					...
					ll.forEach(function (v) {
						related.push(_react2.default.createElement(
							'div',
				...
				if (related.length > 0) {
					related.unshift(_react2.default.createElement(
						'div',
				...
				if (!allinone) {
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'a',
										{ href: snowUI.path.root + '/', onClick: _this.props.getPage },
					...
					var navlinks = _react2.default.createElement('span', null);
				}
				return _react2.default.createElement(
					'div',
					{ id: 'showconent', key: doc._id },
					_react2.default.createElement(snowUI.UI.AppInfo, null),
					display,
					_react2.default.createElement(
						'div',
...
var messageDisplay = function (_React$Component) {
	...
	function messageDisplay(props) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(messageDisplay).call(this, props));

		_this.displayName = 'messageDisplay Component';
		_this.state = {};
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						null,
						' ',
						this.props.title || 'I have an important message for you.'
					),
					_react2.default.createElement(
						'div',
						{ className: 'message' },
...
module.exports = function () {
	...
	var middleware = {
		...
		scrollTop: function scrollTop(route, next) {
			$("#simpledocs").animate({ scrollTop: 0 }, 800);
			next();
		},
		// Track a page view with Google Analytics
		analytics: function analytics(route, next) {
			_gaq.push(['_trackPageview', '/' + route]);
			next();
		},
		logme: function logme(route, next) {
			snow.log('see route', route, next);
		}
	};
	bone.router({
		routes: addroutes,
		middleware: [middleware.scrollTop],
		redirect: function redirect() {
			...
			_reactDom2.default.render(_react2.default.createElement(snowUI.UI.UI, { moon: moon, page: page, allinone: allinone, params: args }), document.getElementById('simpledocs'));
		}

	});
};

},{"react":158,"react-dom":2}],168:[function(require,module,exports){
'use strict';
...
var _Alert = require('./pages/Alert');

var _Alert2 = _interopRequireDefault(_Alert);

var _messageDisplay = require('./pages/messageDisplay');

var _messageDisplay2 = _interopRequireDefault(_messageDisplay);

var _Content = require('./pages/Content');
...
var _Menu = require('./pages/Menu');

var _Menu2 = _interopRequireDefault(_Menu);

var _Banner = require('./pages/Banner');

var _Banner2 = _interopRequireDefault(_Banner);

var _UI = require('./pages/UI');

var _UI2 = _interopRequireDefault(_UI);

var _AppInfo = require('./pages/AppInfo');
...
snowUI.UI = {
	...
	messageDisplay: _messageDisplay2.default,
	Content: _Content2.default,
	home: _home2.default,
	Menu: _Menu2.default,
	Banner: _Banner2.default,
	UI: _UI2.default,
	AppInfo: _AppInfo2.default
};
...
},{"./pages/Alert":159,"./pages/AppInfo":160,"./pages/Banner":161,"./pages/Content":162,"./pages/Menu":163,"./pages/UI":164,"./pages/home":165,"./pages/messageDisplay":166,"./router":167,"react":158}]},{},[168]);
